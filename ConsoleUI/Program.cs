    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Motorcycle motorcycle = new Motorcycle() { HasSideCar = true, Make = "harley davidson", Model = "chopper", Year = 1979 };

            Vehicle sedan = new Car() { HasTrunk = true, Make = "dodge", Model = "Charger", Year = 1969 };
            Vehicle sport = new Car() { HasTrunk = true, Make = "Nissan", Model = "350Z", Year = 2007 };
